...
// SQL ค้นหาข้อมูล grade
$sql = "SELECT GradeID, GradeName
        FROM grade
        WHERE 
            GradeID LIKE '%$search%' OR
            GradeName LIKE '%$search%'
     ...
     <div class="main">
            ...
            <div class="customer-table-container">
                ...
                <div class="search-insert-row">
                    ...
                    <a href="G_insert.php" class="insert-cus-btn">
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <div class="action-buttons">
                                            <a href="G_edit.php?GradeID=<?= $row['GradeID'] ?>" class="edit-btn">Edit</a>
                                            <button type="button" class="delete-btn" onclick="openModal('<?= $row['GradeID'] ?>')">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
   ...
   <script>
    ...
    <div id="deleteModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <form method="post" action="G_delete.php" id="deleteForm">
