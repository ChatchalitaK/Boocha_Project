...
// สร้างคำ SQL สำหรับค้นหาข้อมูลในตาราง Shipment โดยมีการกรองจากคำค้นหาใน ShipmentID, OrderID และ Shipping_type
$sql = "SELECT UserID, Username, Firstname, Lastname, Shipping_Address, Tel_number, Email, latest_update 
        FROM user 
        WHERE role = 'Customer' 
        AND (
            ...
            Shipping_Address LIKE '%$search%' OR
...
<body>
            ...
            <div class="customer-table-container">
                ...
                <div class="search-insert-row">
                    ...
                    <div class="button-group">
                        ...
                        <a href="CM_insert.php" class="insert-cus-btn">
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <div class="action-buttons">
                                            <a href="CM_edit.php?UserID=<?= $row['UserID'] ?>" class="edit-btn">Edit</a>
   ...
   <script>
    ...
    <div class="modal-content">
        ...
        <form method="post" action="CM_delete.php" id="deleteForm">
