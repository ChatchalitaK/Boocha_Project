...
// SQL ค้นหาข้อมูล province
$sql = "SELECT ProvinceID, ProvinceName
        FROM province
        WHERE 
            ProvinceID LIKE '%$search%' OR
            ProvinceName LIKE '%$search%'
...
<body>
     ...
     <div class="main">
            ...
            <div class="customer-table-container">
                ...
                <div class="search-insert-row">
                    <form method="get" action="province.php">
                        <div class="search">
                            <label>
                    ...
                    <a href="PV_insert.php" class="insert-cus-btn">
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <div class="action-buttons">
                                            <a href="PV_edit.php?ProvinceID=<?= $row['ProvinceID'] ?>" class="edit-btn">Edit</a>
                                            <button type="button" class="delete-btn" onclick="openModal('<?= $row['ProvinceID'] ?>')">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
   ...
   <script>
    ...
    document.getElementById('deleteProvinceID').value = provinceID;
    ...
    <div id="deleteModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <form method="post" action="PV_delete.php" id="deleteForm">
                <input type="hidden" name="ProvinceID" id="deleteProvinceID">
